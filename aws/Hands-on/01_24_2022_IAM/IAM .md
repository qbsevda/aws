...
Purpose of the this hands-on training is to learn basic understanding of how to use IAM and IAM components.
...
- Show IAM users "sign-in link" and customize it as alias . Write down the account alias.

- Create IAM user with Administrator access for your daily work :

    - Explain that  unless it is needed, we won't use root account anymore.
